...
#cap = cv2.VideoCapture('highway_mini_fast.mp4')
...
while True:
        ...
        if id in down:
           ...
           if blue_line_y<(cy+offset) and blue_line_y > (cy-offset):
             ...
             if counter_down.count(id)==0:
                ...
                distance = 40 # meters - distance between the 2 lines is 10 meters
        ...
        if id in up:
           ...
           if red_line_y<(cy+offset) and red_line_y > (cy-offset):
             ...
             if counter_up.count(id)==0:
                ...
                distance1 = 40 # meters  (Distance between the 2 lines is 40 meters )
    ...
    cv2.putText(frame, current_time, (130, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1, cv2.LINE_AA)
    ...
    #cv2.putText(frame, current_time, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.9, text_color, 2)
